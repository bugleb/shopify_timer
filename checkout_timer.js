...
function detectShipping () {
    ...
    if (typeof shippingLabel === 'undefined') {
        ...
        shippingLabel[0].innerHTML = '<strong>Standard Shipping</strong><span class="radio__label__primary" data-shipping-method-label-title="Standard Shipping">1-3 weeks for delivery in the United States, and 2-6 weeks for international orders (depending on location).</span>';
    }
}
